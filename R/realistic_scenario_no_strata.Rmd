...
IN RESPONSE TO REVIEWER COMMENTS, WE MODIFY THIS EXAMPLE BY REMOVING THE STRATIFICATION FROM THE DATA GENERATING PROCESS AND THE YE ET EL. ANALYSIS METHOD.
...
Our working model is $logit[P(Y_i = 1 | A, X)] = b_0 + b_1A + b_2Z_1 + b_3X_2$ and thus our results correspond to method 'LR-Discrete-2' in Ge et al (2011). (OUR RESULTS NO LONGER CORRESPOND TO GE ET AL. SINCE WE HAVE REMOVED STRATIFIED RANDOMIZATION FROM THE DATA GENERATING PROCESS)
...
scenarios <- list(
  list(scenario = 1, 
       ...
       stratified_randomization = F,
       #strata = c("x2", "z1"), REMOVING STRATA FROM THE ANALYSIS
       # 2:1 assignment
       trt_assignment = 2/3,
