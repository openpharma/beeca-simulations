---
title: "Extended misspecified scenarios"
...
scenarios <- list(
  ...
  list(scenario = 5, 
       ...
       # outcome model 
       response_func = \(df) -1 - 3 * df$x * df$trt + 3 * df$x,
       working_model = "y ~ trt + x"
  ),
  list(scenario = 6, 
       N = 4000,
  ...
  list(scenario = 9, 
       ...
       # outcome model 
       response_func = \(df) -1 - 1 * df$x * df$trt + 1 * df$x,
       working_model = "y ~ trt + x"
  ),
  list(scenario = 10, 
       N = 4000,
  ...
  list(scenario = 13, 
       ...
       # outcome model 
       response_func = \(df) -1 - 2 * df$x * df$trt + 2 * df$x,
       working_model = "y ~ trt + x"
  ),
  list(scenario = 14, 
       N = 4000,
  ...
  list(scenario = 17, 
       ...
       # outcome model 
       response_func = \(df) -1 - 3 * df$x * df$trt + 1 * df$x,
       working_model = "y ~ trt + x"
  ),
  list(scenario = 18, 
       N = 4000,
  ...
  list(scenario = 21, 
       ...
       # outcome model 
       response_func = \(df) -1 - 1 * df$x * df$trt + 3 * df$x,
       working_model = "y ~ trt + x"
  ),
  list(scenario = 22, 
       N = 4000,
